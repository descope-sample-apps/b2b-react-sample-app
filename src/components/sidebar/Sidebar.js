...
import "./sidebar.scss";
import { MdBarChart, MdManageAccounts, MdApps, MdVerifiedUser, MdOutlineSettingsApplications, MdHome, MdKey, MdOutlineAdminPanelSettings } from "react-icons/md";
...
const items = [
  ...
  getItem("User And Key Management", "/admin/widgets", <MdOutlineAdminPanelSettings style={{ fontSize: '1.5em' }} />),
  getItem("Company Settings", "/admin/tenant-profile", <MdOutlineSettingsApplications style={{ fontSize: '1.5em' }} />)
];
    ...
    <section className="sidebar-container">
      ...
      <Menu
        ...
        items={items.map((item) => {
          ...
          if ((label === "SSO Setup" || label === "Management" || label === "Audit" || label === "Tenant Profile") && !isTenantAdmin()) {
            item.disabled = true;
